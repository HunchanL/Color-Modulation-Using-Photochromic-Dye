...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\octo_ctrl\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\octo_ctrl\hook\ament_prefix_path.bat"
